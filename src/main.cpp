...
uint256 hashGenesisBlock("0x9aed7190a881b7be5acd47e84bf099e2f562798ba41a9d7df6d3ef2b616dd6bb");
...
return nSubsidy + nFees;
    ...
    // Subsidy is cut in half every 105120 blocks, which will occur approximately every 1 year
    nSubsidy >>= (nHeight / 105120); // Bestcoin: 105k blocks in ~1 year
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Pope Francis says gays must not be judged or marginalized";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1375116100; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2658299;

        if (fTestNet)
        {
            block.nTime    = 1375116100;
            block.nNonce   = 2658299;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xdbd90aa1431c12f2c14cdfb4becf680ffa72fad01e7788f2927b5592a6004cbe"));
